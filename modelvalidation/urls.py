...
from . import viewpycaret
# from . import exportFromIpynb

urlpatterns = [
    path('index/', views.index),
    path('', viewviex.table, name="home"),
...
#          name="bubblePlot3d"),
     ...
     path('showCatCountPlot/', viewviex.showCatCountPlot,
          name="showCatCountPlot"),
     path('plotinsured_occupations/', viewviex.plotinsured_occupations,
          name="plotinsured_occupations"),
     path('plotinsoccuvsincstate/', viewviex.plotinsoccuvsincstate,
          name="plotinsoccuvsincstate"),
     path('plotinsoccuvsincstatestacked/', viewviex.plotinsoccuvsincstatestacked,
          name="plotinsoccuvsincstatestacked"),
     path('vardistbyfraudold/', viewviex.var_dist_by_fraud_old,
          name="vardistbyfraudold"),
     path('pairwise_correlation/', viewviex.pairwise_correlation,
          name="pairwise_correlation"),
     path('vardistbyfraud/', viewviex.vardistbyfraud,
          name="vardistbyfraud"),
     path('stripplot/', viewviex.stripplot,
          name="stripplot"),
     path('totalclaim_boxplot/', viewviex.totalclaim_boxplot,
          name="totalclaim_boxplot"),
     path('vehicleclaim/', viewviex.vehicle_claim,
          name="vehicleclaim"),
     path('scattred3d/', viewviex.scattred3d,
          name="scattred3d"),
     path('bubblePlot3d/', viewviex.bubblePlot3d,
          name="bubblePlot3d"),
    ...
    re_path('getAllCRComments/$', modelview.getAllCRComments,
     ...
     path('VaroReport/', modelview.ReportTxtEdVaro,name='VaroReport'),
        ...
        path('sampleEDAData/',viewviex.sampleEDAData,name='sampleEDAData'),
        re_path(r'sampleDateRange/$',viewviex.sampleDateRange,name='sampleDateRange'),
        re_path(r'CheckDagta/$',viewviex.CheckDagta,name='CheckDagta'),  
        re_path(r'saveEDASampleData/$',viewviex.saveEDASampleData,name='saveEDASampleData'),
        ...
        path('setuppycaret/',viewpycaret.setuppycaret,name='setuppycaret'),
        path('setupRF/',viewpycaret.randomForestAjax,name='setupRF'),
        path('xgboostpycr/',viewpycaret.xgboostpycr,name='xgboostpycr'),
        path('GBCpycr/',viewpycaret.GBCpycr,name='GBCpycr'),
        re_path(r'runpycaret/$', viewpycaret.runpycaret, name='runpycaret'),
        path('MSA/',modelview.MSA,name='MSA'),
        re_path(r'getNTShap/$',modelview.getNTShap,name='getNTShap'), 
        re_path(r'saveConfig/$',viewpycaret.saveConfig,name='saveConfig'), 
        path('cmpmodels/',viewpycaret.cmpmodels,name='cmpmodels'),
        path('runBestModel/',viewpycaret.runBestModel,name='runBestModel'),
        re_path(r'runSelectedModel/$',viewpycaret.runSelectedModel,name='runSelectedModel'),
        re_path(r'getPycrParamName/$',viewpycaret.getPycrParamName,name='getPycrParamName'),
        re_path(r'setPycrParamName/$',viewpycaret.setPycrParamName,name='setPycrParamName'),
        re_path(r'showPycrOutputs',viewpycaret.showPycrOutputs,name='showPycrOutputs'),
        re_path(r'updateParams',viewpycaret.updateParams,name='updateParams'),
]
